            ...
            <div class="left-panel pa-8 h-100 d-flex flex-column">
              ...
              <div class="mt-10">
                ...
                <p class="welcome-subtitle mt-3">
                  Đăng nhập để tiếp tục học tập và kết nối cùng bạn bè.
                </p>
              </div>
            ...
            <v-card flat class="form-card pa-10 h-100">
              <div class="text-center mb-8">
                <div class="avatar-circle mx-auto">
                  <v-icon size="44" color="#3d5afe">mdi-school</v-icon>
                </div>
                <h1 class="page-title mt-4">
                  Đăng nhập <span class="title-highlight">học sinh</span>
                </h1>
              ...
              <v-form ref="formRef" @submit.prevent="handleSubmit">
                ...
                <div class="d-flex align-center justify-space-between mb-4">
                  ...
                  <router-link
                    ...
                    style="color: #3d5afe; font-size: 0.9rem"
                  >
                    Quên mật khẩu?
                  </router-link>
                </div>
...
async function handleSubmit() {
  ...
  try {
    ...
    if (data.role !== "student") {
      authStore.logout();
      errorMsg.value =
        "Tài khoản này không phải học sinh, vui lòng đăng nhập ở trang giáo viên";
      return;
    }
